...
$mail = 'manou3d@free.fr'; // Déclaration de l'adresse de destination.
...
//=====Définition du sujet.
$sujet = "Ici le sujet du mail";
//=========
 
//=====Création du header de l'e-mail.
$header = "From: \"testMail\"<max@webdesignord.fr>".$passage_ligne;
$header.= "Reply-to: \"formTest\" <manu@mail.fr>".$passage_ligne;
